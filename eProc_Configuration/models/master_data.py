...
class DBQueries:
    ...
    def get_catalog_fields(self, client,catalog_id_query,catalog_desc_query,catalog_name_query, product_type_query,
                           search_count):
        return list(Catalogs.objects.filter(catalog_id_query,catalog_desc_query,catalog_name_query, product_type_query, client=client,
    ...
    def get_product_details_by_fields(client, obj, supp_query, product_category_query, product_id_query,
        ...
        return list(ProductsDetail.objects.filter(supp_query, product_category_query,
                                                  ...
                                                  del_ind=False).values('product_id', 'short_desc', 'supplier_id',
                                                                        ...
                                                                        'prod_cat_id').order_by('product_id')[:int(count)])
...
class ProductsDetail(models.Model, DBQueries):
    ...
    prod_cat_id = models.ForeignKey('eProc_Configuration.UnspscCategories', models.DO_NOTHING, db_column='PROD_CAT_ID', null=True)
...
class DBQueriesSupplier:
    ...
    @staticmethod
    def get_supplier_details_by_fields(client, block,obj, name1_query, name2_query, supplier_id_query, search_term1_query,
