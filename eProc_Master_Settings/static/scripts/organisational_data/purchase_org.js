    ...
    for (var i = 0; i < $chkbox_all.length; i++) {
        if ($chkbox_all[i].checked) {
            ...
            if(GLOBAL_ACTION == "UPDATE"){
                ...
                unique_input = '<input class="input form-control check_special_character"  value="' + row.cells[1].innerHTML + '" type="text" maxlength="8"  name="porg_id" disabled>'
                ...
                porg_guid = 'GUID';
                unique_input = '<input class="input form-control check_special_character" value="' + row.cells[1].innerHTML + '"  type="text" maxlength="8"  name="porg_id"required>'
