...
def get_acc_value_desc_dropdown():
    ...
    upload_accassvalues = django_query_instance.django_filter_query(AccountingData,
                                                                    {'client': global_variables.GLOBAL_CLIENT,
                                                                     'del_ind': False,
                                                                     'account_assign_cat': CONST_GLACC}, None,
                                                                    ['account_assign_value', 'account_assign_cat',
                                                                     'company_id'])
...
def get_gl_acc_dropdown():
    ...
    upload_value_glacc = list(
        AccountingData.objects.filter(client=global_variables.GLOBAL_CLIENT, del_ind=False,account_assign_cat='GLACC').values(
            'account_assign_value'))
...
def get_gl_acc_data():
    upload_gl_acc_db = list(
        DetermineGLAccount.objects.filter(client=global_variables.GLOBAL_CLIENT, del_ind=False).values('det_gl_acc_guid', 'prod_cat_id',
