    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rfq_item_num', models.PositiveIntegerField(db_column='RFQ_ITEM_NUM', verbose_name='Line Number')),
                ...
                ('final_entry_ind', models.BooleanField(db_column='FINAL_ENTRY_IND', default=False)),
                ...
                ('ir_gr_ind_limi', models.BooleanField(db_column='IR_GR_IND_LIMI', null=True, verbose_name='Gr ind for LO')),
                ('gr_ind_limi', models.BooleanField(db_column='GR_IND_LIMI', null=True, verbose_name='Gr ind for LO')),
                ...
                ('offcatalog', models.BooleanField(blank=True, db_column='OFFCATALOG', null=True, verbose_name='Off Catalog Flag(false=Not from catalog)')),
                ...
                ('bundle_flag', models.BooleanField(db_column='BUNDLE_FLAG', default=False)),
                ...
                ('ship_from_addr_num', models.CharField(db_column='SHIP_from_ADDR_NUM', max_length=10, verbose_name='ship from addr num')),
