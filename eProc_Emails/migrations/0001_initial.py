# Generated by Django 3.1.7 on 2022-06-09 14:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_status', models.PositiveIntegerField(db_column='EMAIL_STATUS', max_length=3)),
                ('error_type', models.CharField(db_column='ERROR_TYPE', max_length=20)),
                ...
                ('email_contents_guid', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='eProc_Configuration.emailcontents')),
            ],
            options={
