    ...
    function change_account_assignment_category() {
        ...
        var acc_val = '';
        if(acc_cat=='CC - Cost Center'){
            acc_val = document.getElementById('CC - Cost Center').value
        } else if (acc_cat=='AS - Asset'){
            acc_val = document.getElementById('AS - Asset').value
        }else if (acc_cat=='WBS - Project'){
            acc_val = document.getElementById('WBS - Project').value
        }else if (acc_cat=='OR - Internal Order'){
            acc_val = document.getElementById('OR - Internal Order').value
        }
        ...
        for(i=0; i< acc_asign_class.length; i++){
            ...
            if(acc_cat != account_assignment_id){
